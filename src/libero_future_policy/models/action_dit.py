...
from libero_future_policy.conditioning.fusion import ConditioningFusion
from libero_future_policy.models.blocks import DiTBlock, FinalLayer, timestep_embedding
...
class ActionDiT(nn.Module):
    """Compact DiT-style transformer specialized for action chunks."""
